...
class CompanyInfoViewController: UIViewController {
    ...
    lazy var subViewControllers:[UIViewController] = {
        return [
            UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "companyDetails") as! CompanyDetailsViewController,
            UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "companyPosts") as! CompanyPostsViewController,
            ]
    }()
    
    
    var currentIndex: Int = 0
    var tabs = ["Details","Vacancy"]
    ...
    func presentPageVCOnView() {
        ...
        self.pageController.view.frame = CGRect.init(x: 0, y: menuBarView.frame.maxY + 110, width: self.view.frame.width, height: self.view.frame.height - menuBarView.frame.maxY)
    ...
    func viewController(At index: Int) -> UIViewController? {
        ...
        let contentVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "companyDetails") as! CompanyDetailsViewController
        currentIndex = index
        return contentVC
    }
}
...
extension CompanyInfoViewController: MenuBarDelegate {
...
extension CompanyInfoViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        if finished {
            if completed {
                if (pageViewController.viewControllers![0] is CompanyDetailsViewController) {
                    currentIndex = 0
                }else if (pageViewController.viewControllers![0] is CompanyPostsViewController ){
                    currentIndex = 1
                }
